      ...
      <Grid container style={{ paddingTop: "20px" }}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Typography variant="body1" className={classes.typo}>
            ...
            technologies & databases. Our rich expertise in different
            technologies has been generated in the course of delivering numerous
            JavaScript projects for our clients in different parts of the world.
          </Typography>
        </Grid>
      </Grid>
    </Zoom>
